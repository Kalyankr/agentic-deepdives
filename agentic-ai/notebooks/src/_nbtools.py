...
# Every notebook starts with this cell so ``import shared`` works no matter how the
# kernel was launched (VS Code, `jupyter lab` from any dir). It walks up to the
# project root (the folder containing ``shared/llm.py``) and puts it on sys.path.
BOOTSTRAP = code(
    "import sys, pathlib\n"
